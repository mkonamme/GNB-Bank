...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      <!-- Logo Image -->
      <img src="iu.jpg" width="80" alt="" class="d-inline-block align-left mr-2">
      <!-- Logo Text -->
      <span class="text-uppercase font-weight-bold">THE GNB BANK</span>
    </a>
...
?>
 <div class="container">
    ...
    <div class="row mb-3">
    <div class="col-md-4">
    <div class="card"style="width: 27rem ;background-color:#808080">
        <div class="card-body">
...
{
    echo "<h3 class='text-center'><b>NO TRANSACTION TILL NOW</b></h3>";
}
$link->close();
?>
<div>
